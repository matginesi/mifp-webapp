...
class TestDashboardRoutes:
    ...
    def test_conference_site_wizard_and_deploy_download(self, live_server, page):
        ...
        page.get_by_role("button", name="New manual workspace").click()
        ...
        expect(modal.locator('[data-conference-step-marker="2"].is-active')).to_contain_text("Event & publication")
        modal.locator('[name="city"]').fill("Rome")
        modal.get_by_role("button", name="Create workspace").click()
